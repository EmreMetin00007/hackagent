...
SKILL_SIGNALS = {
    ...
    "access-control-hunting": (["broken access control", "bola", "bfla", "authorization",
                                "idor", "horizontal", "vertical privilege", "business logic",
                                "price manipulation", "mass assignment", "race condition",
                                "workflow", "coupon", "owasp api", "access control"],
                               "/access-control-hunting"),
